...
本项目是一个基于 JavaSE 实现的控制台版仓库进销存管理系统。

其目标不是单纯增加功能数量，而是展示课程知识如何在实际项目中形成完整、清晰、可讲解的实现方案。
...
课程项目中常见的问题是：程序虽然可以运行，但结构混乱、职责交叉、讲解困难。

本项目希望展示如何从“能够运行”进一步提升到“结构清晰、职责明确、便于说明”的工程实现，使代码具备以下特点：
- 结构清晰（分层明确）
- 易于扩展（好改好加功能）
- 稳定可靠（异常情况不会崩）
- 可追溯（有日志）
